# 🎯 Contributing to Arweave Support Extension
...
This project and everyone participating in it is governed by the Arweave Support Extension [Code of Conduct](https://github.com/warengonzaga/arweave-support-extension/blob/master/code_of_conduct.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@warengonzaga.com>.
